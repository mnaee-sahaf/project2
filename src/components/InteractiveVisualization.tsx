...
//         <Sliders className="text-indigo-600" size={20} sm:size={24} />
//         <h3 className="text-lg sm:text-xl font-semibold">Model Parameters</h3>
//       </div>
...
//                 {param.name}
//               </label>
//               <span className="text-xs sm:text-sm text-gray-500">{param.value}</span>
//             </div>
//             <input
//               type="range"
//               min={param.min}
...
//               className="w-full h-1.5 sm:h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-indigo-600"
//             />
//           </div>
//         ))}
//       </div>
...
//         <h4 className="text-xs sm:text-sm font-medium text-gray-700 mb-2">Model Output</h4>
